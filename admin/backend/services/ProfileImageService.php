...
final class PrivateProfileImageStorage
{
    ...
    public static function configured(): self
    {
        ...
        return new self(dirname($projectRoot) . '/ssms_private/profiles');
    }
...
final class ProfileImageService
{
    ...
    public static function prepareBytes(string $raw): ProfileImageArtifact
    {
        ...
        if ($width < self::MIN_DIMENSION || $height < self::MIN_DIMENSION
            ...
            throw new ProfileImageDomainException(
                ...
                'Image dimensions or pixel count exceed the allowed limits.'
            );
        }
    ...
    public function replaceOwnImage(
        ...
        if ($expectedVersion === '') {
            throw new ProfileImageDomainException('PROFILE_VERSION_REQUIRED', 'Profile version is required.');
        }
    ...
    public function removeOwnImage(
        ...
        try {
            ...
            if ($expectedVersion === ''
                || !hash_equals(ProfileService::profileVersion($row), $expectedVersion)) {
                throw new ProfileImageDomainException(
                    'PROFILE_CONFLICT',
                    'The profile changed. Reload it and review your changes.'
                );
