...
<div id="txnMemberWrap"><label for="txnMemberSearch" style="font-size:.7rem;color:var(--dm)">Member (optional)</label><input id="txnMemberSearch" class="inp" style="width:100%" type="search" autocomplete="off" placeholder="Search name, phone, or member code" data-member-picker-target="txnMember"><select id="txnMember" class="inp" style="width:100%" data-optional="true"><option value="">— None —</option></select></div>
...
<div style="display:flex;flex-direction:column;gap:.75rem">
<div><label for="feeMemberSearch" style="font-size:.7rem;color:var(--dm)">Member</label><input id="feeMemberSearch" class="inp" style="width:100%" type="search" autocomplete="off" placeholder="Search name, phone, or member code" data-member-picker-target="feeMember"><select id="feeMember" class="inp" style="width:100%"><option value="">Select member…</option></select></div>
...
$navItems = [
    [
        ...
        ['icon' => 'fa-solid fa-arrow-trend-up', 'label' => 'Income', 'attrs' => 'data-section="income"'],
        ['icon' => 'fa-solid fa-arrow-trend-down', 'label' => 'Expense', 'attrs' => 'data-section="expense"'],
        ['icon' => 'fa-solid fa-hand-holding-dollar', 'label' => 'Fees', 'attrs' => 'data-section="fees"'],
    ],
    [
...
<script src="/frontend/js/member-picker.js"></script>
<script>
