...
function sectionLabelFromGroup(?string $ageGroup): string
{
    return match ($ageGroup) {
        'under6'  => 'áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ',
        '7_13'    => 'áˆ…áŒ»áŠ“á‰µ',
        '14_17'   => 'áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•',
        '18_plus' => 'á‹ˆáŒ£á‰¶á‰½',
        default   => '',
    };
}
                    ...
                    <div class="panel p-4 mobile-card">
                        ...
                        <div class="grid grid-cols-2 gap-3 mt-3">
                            <div class="p-3 rounded-2xl bg-emerald-50 border border-emerald-100">
                                <div class="text-[11px] text-emerald-700 amharic-text">áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ</div>
                            ...
                            <div class="p-3 rounded-2xl bg-sky-50 border border-sky-100">
                                <div class="text-[11px] text-sky-700 amharic-text">áˆ…áŒ»áŠ“á‰µ</div>
                            ...
                            <div class="p-3 rounded-2xl bg-amber-50 border border-amber-100">
                                <div class="text-[11px] text-amber-700 amharic-text">áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•</div>
                            ...
                            <div class="p-3 rounded-2xl bg-rose-50 border border-rose-100">
                                <div class="text-[11px] text-rose-700 amharic-text">á‹ˆáŒ£á‰¶á‰½</div>
                        ...
                        <div class="flex flex-wrap gap-2 md:justify-end w-full md:w-auto">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <select id="filterAgeGroup"
                                    ...
                                    <option value="under6">áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ</option>
                                    <option value="7_13">áˆ…áŒ»áŠ“á‰µ</option>
                                    <option value="14_17">áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•</option>
                                    <option value="18_plus">á‹ˆáŒ£á‰¶á‰½</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white border border-slate-200 rounded-xl p-3 sm:p-4 mb-4">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-[auto,minmax(0,1fr)] gap-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        <label class="block text-[11px] font-medium text-slate-700 mb-1">
                                            Baptismal Name (á‹¨áŠ­áˆ­áˆµá‰µáŠ“ áˆµáˆ)
                                        </label>
        ...
        <div class="overflow-x-auto border rounded-lg">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                    ...
                    $typeMap = [
                        'direct' => 'áˆ˜á‹°á‰ áŠ› (Regular)',
                        'transfer' => 'áˆá‹© áˆ˜á‹°á‰ áŠ› (Student+)',
                        'honorary' => 'á‹¨áŠ­á‰¥áˆ­ áŠ á‰£áˆ‹á‰µ'
                    ];
            ...
            <section id="section-reports" class="content-section">
                ...
                <div class="panel p-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                        <div class="bg-emerald-50 p-3 rounded-xl"><div class="text-lg font-bold text-emerald-700"><?= $sectionCounts['under6'] ?></div><div class="text-[10px] text-emerald-600 amharic-text">áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ</div></div>
                        <div class="bg-sky-50 p-3 rounded-xl"><div class="text-lg font-bold text-sky-700"><?= $sectionCounts['7_13'] ?></div><div class="text-[10px] text-sky-600 amharic-text">áˆ…áŒ»áŠ“á‰µ</div></div>
                        <div class="bg-amber-50 p-3 rounded-xl"><div class="text-lg font-bold text-amber-700"><?= $sectionCounts['14_17'] ?></div><div class="text-[10px] text-amber-600 amharic-text">áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•</div></div>
                        <div class="bg-rose-50 p-3 rounded-xl"><div class="text-lg font-bold text-rose-700"><?= $sectionCounts['18_plus'] ?></div><div class="text-[10px] text-rose-600 amharic-text">á‹ˆáŒ£á‰¶á‰½</div></div>
                    </div>
                </div>
            </section>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <select id="defAgeGroup" class="w-full px-3 py-2.5 rounded-xl border border-slate-200 text-sm focus:ring-2 focus:ring-teal-200 focus:border-teal-400">
                                        ...
                                        <option value="under6">Under 6 (áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ)</option>
                                        <option value="7_13">7-13 (áˆ…áŒ»áŠ“á‰µ)</option>
                                        <option value="14_17">14-17 (áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•)</option>
                                        <option value="18_plus">18+ (á‹ˆáŒ£á‰¶á‰½)</option>
                                    </select>
                                </div>
                                <div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        new Chart(sectionCtx, {
            type: 'bar',
            data: {
                labels: ['áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ', 'áˆ…áŒ»áŠ“á‰µ', 'áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•', 'á‹ˆáŒ£á‰¶á‰½'],
                datasets: [{
                    data: [
    ...
    function calculateAgeSection() {
        ...
        if (age <= 6) {
            sectionLabel = 'áŠ áŒ¸á‹° áˆ…áŒ»áŠ“á‰µ';
            ageGroup = 'under6';
        } else if (age >= 7 && age <= 13) {
            sectionLabel = 'áˆ…áŒ»áŠ“á‰µ';
            ageGroup = '7_13';
        } else if (age >= 14 && age <= 17) {
            sectionLabel = 'áˆ›á‹•áŠ¨áˆ‹á‹Šá‹«áŠ•';
            ageGroup = '14_17';
        } else {
            sectionLabel = 'á‹ˆáŒ£á‰¶á‰½';
            ageGroup = '18_plus';
        }
    ...
    function renderArchivedMembers(members) {
        ...
        const reasonLabels = {
            'left_school': 'áŠ¨á‰µ/á‰¤á‰µ á‹ˆáŒ¥á‰·áˆ',
            'graduated': 'á‰°áˆ˜áˆ­á‰‹áˆ',
            'transferred': 'á‰°á‹›á‹áˆ¯áˆ',
            'inactive_long': 'áˆ¨áŒ…áˆ áŒŠá‹œ á‰¦á‹',
            'deceased': 'áŠ áˆ­ááˆ',
            'other': 'áˆŒáˆ‹'
        };
        ...
        listContainer.innerHTML = members.map(m => {
            ...
            const section = m.current_section || m.age_group || 'â€”';
            const reason = reasonLabels[m.archive_reason] || m.archive_reason || 'Unknown';
            const archivedDate = m.archived_at ? (typeof WBWSCalendar!=='undefined'?WBWSCalendar.formatDate(m.archived_at,'medium'):new Date(m.archived_at).toLocaleDateString('en-GB')) : 'â€”';
