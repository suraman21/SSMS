...
/**
 * ============================================================
 * Notifications — thin shell (P73 Phase 2)
 * ============================================================
 * The full Communication experience lives in the shared partial
 * (admin/components/comm/comm_section.php) rendered by every
 * dashboard. This page is the deep-link URL (bell, bookmarks,
 * the mobile app): the same partial in page mode. Zero business
 * logic and zero page-specific CSS/JS — updating the partial or
 * comm.css/comm.js updates every surface at once.
 */
...
<title>Notifications — <?= e(defined('SCHOOL_NAME_SHORT') ? SCHOOL_NAME_SHORT : 'School') ?></title>
...
<div class="nc-page-top">
    ...
    <div class="nc-page-title">
        <div><i class="fa-solid fa-bell" aria-hidden="true"></i> Notifications
